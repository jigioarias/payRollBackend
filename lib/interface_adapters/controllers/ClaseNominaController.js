...
module.exports = {
  ...
  async createClaseNomina(request) {
    ...
    // Treatment
    const claseNomina = await CreateClaseNomina( enterprise, clase, description, vacationDays,vacationPrima,
        primatype,provisionservicedays,provisionservicetype,payrolltype,monthhours,dayshours,bank,bankbranch,account,user, { claseNominaRepository });
