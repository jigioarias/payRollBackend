...
module.exports = {
    ...
    async ingresar(request) {
       ...
       const active = true; 
       const  guardarIncapacidad = await CreateIncapacidadEmpleado(enterprise, document, initDate, endDate,type,user,employeeId,year, periodo,clase,salary,active,percentage, { incapacidadRepository});
       
    
       if(guardarIncapacidad.id !=null){
