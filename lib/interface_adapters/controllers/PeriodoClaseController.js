...
module.exports = {
  ...
  async findPeriodosPorClase(request) {
    ...
    // Treatment
    console.log('llamandoooooo aca')
    const periodoCLase = await ListPeriodosPorClase(request.payload.enterprise,request.payload.classPayRoll,request.payload.active,{ periodClaseRepository });
