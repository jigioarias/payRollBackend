...
module.exports = {
  ...
  async findConceptoNominas(request) {

    // Treatment
    const ConceptoNominas = await ListConceptoNominas(request.payload.enterprise,request.payload.active, { conceptoNominaRepository });
