...
module.exports = {
  ...
  async find(request) {
    ...
    try {
      ...
      const retrieveALL = request.payload.retrieveALL;
      const enterprise = request.payload.enterprise;
      
      const empleado = await GetEmpleado(enterprise,document,active,retrieveALL,{ personaRepository },{empleadoRepository},{claseNominaRepository},{periodoClaseRepository},
  ...
  async get(request) {
    ...
    try {
      ...
      const empleado = await FindEmpleado(document,enterprise,active,
        {personaRepository},{empleadoRepository},{claseNominaRepository},{prestacionSocialRepository},
