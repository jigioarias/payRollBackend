...
module.exports = {
  ...
  async find(request) {
    ...
    try {
      ...
      const empleado = await GetEmpleado(1,document,true,{ personaRepository },{empleadoRepository},{claseNominaRepository},{periodClaseRepository},{semanaLaboralRepository},{calendarioLaboralRepository});
