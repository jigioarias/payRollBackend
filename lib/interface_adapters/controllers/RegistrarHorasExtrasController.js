...
const ListHorasExtras = require('../../application_business_rules/use_cases/ListHorasExtras');
...
module.exports = {
  ...
  async list(request) {
    ...
    // Input
    // Treatment
    const lista = await ListHorasExtras(request.payload, {horasExtrasRepository  }, { personaRepository },{conceptoRepository});
    // Output
