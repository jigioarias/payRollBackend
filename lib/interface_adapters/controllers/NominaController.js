...
const {CONCEPTO_LICENCIA,DESCRIPCION_CONCEPTO_AUXILIO_TRANSPORTE,VALOR_AUXILIO_TRANSPORTE,VALOR_SALARIO_TRANSPORTE,CONCEPTO_AUXILIO_TRANSPORTE,CONCEPTO_VACACION_SALARIO} =require('./constantesParametros')
const {DIAS_COMERCIAL,DIAS_JULIANO,CODIGO_DIAS_JULIANO,CODIGO_PENDIENTE,TIPO_AJUSTE_SUMA, TIPO_AJUSTE_RESTA} =require('./constantesSistema')
...
module.exports = {
  async createNomina(request) {
    ...
    try {
      ...
      let conceptoLicencia= await ListParametroDescripcion(empresaId,CONCEPTO_LICENCIA,{parametroRepository});
      ...
      if(empleados != null){
          for ( let empleado of empleados) {
           ...
           // console.log(getDiasVacacionesNominaEmpleado);
            dias = dias - getDiasVacacionesNominaEmpleado - getDiasLicencias;
            ...
            if(getDiasLicencias >0){
              valorSalarioLicencia = salariodia* getDiasLicencias ;
           ...
           if(conceptosNominaBasicos != null){
            ...
            for(let iconcepto of conceptosNominaBasicos ){
                ...
                valorConcepto = PayRollRules.calcularConceptoBasicosNomina(salario+valorSalarioVacaciones+valorSalarioLicencia,iconcepto);
            ...
            mominaRegistro = new Nomina(
              ...
              if(getDiasLicencias >0){
                ...
                guardarNovedadLicencia = await CreateNovedadNominaEmpleado(
                  ...
                  empleado.employee.id,
                  empleado.person.document,
                  conceptoLicencia.value,
                  periodValue,
                  valorSalarioLicencia,
                  getDiasLicencias* request.payload.classPayRoll.dayshours, 
                  fechaInicioPeriodo,
                  fechaFinPeriodo,
                  user,
                  TIPO_AJUSTE_RESTA,
