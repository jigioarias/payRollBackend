...
module.exports = {
  async createNomina(request) {
    ...
    try {
      ...
      let getVacacionesNominaEmpleado = null;
          ...
          for ( let empleado of empleados) {
           ...
           if(conceptosNominaBasicos != null){
            ...
            mominaRegistro = new Nomina(
              ...
              getVacacionesNominaEmpleado = await GetVacacionesNominaEmpleado(empresaId,empleado.employee.id,empleado.person.document,yearPeriod, periodValue,request.payload.classPayRoll.id,initDatePeriod,endDatePeriod,{vacacionRepository})
