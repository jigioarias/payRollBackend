...
const {DIAS_COMERCIAL,DIAS_JULIANO,CODIGO_DIAS_JULIANO,CODIGO_PENDIENTE,TIPO_AJUSTE_SUMA, TIPO_AJUSTE_RESTA,NOVEDAD_PENDIENTE} =require('./constantesSistema')
    ...
    //console.log('listGroupConceptos ',listGroupConceptos);   
      ...
      if(empleados != null){
          for ( let empleado of empleados) {
            ...
            console.log('lista presdtamos controller',listaPrestamos);
