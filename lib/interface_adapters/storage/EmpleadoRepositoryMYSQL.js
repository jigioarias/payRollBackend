...
module.exports = class {
  ...
  async persist(empleadoEntry) {
    ...
    const { enterprise, idPerson, salary, salaryType,initDateContract,endDateContract, costCenter, classPayRoll, department,branchOffice,unity,area,active,user ,transporteSubsidy} = empleadoEntry;
    ...
    department,branchOffice,unity,active,user,transporteSubsidy,idPerson, enterprise,area,classPayRoll});
