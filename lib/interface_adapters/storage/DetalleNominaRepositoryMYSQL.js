...
module.exports = class {
  ...
  async persist(detalleNominaEntity) {
    ...
    await seqDetalleNomina.save();
     ...
     return new DetalleNomina(seqDetalleNomina.id,  seqDetalleNomina.enterprise, seqDetalleNomina.payrollId, seqDetalleNomina.employeeId, seqDetalleNomina.period, seqDetalleNomina.concept, seqDetalleNomina.conceptName, 
...
async find(detalleNominaEntity) {
    ...
    const seqDetalleNominas = await this.model.findAll({ where: { enterprise: detalleNominaEntity.enterprise, payrollId: detalleNominaEntity.payrollId,period:detalleNominaEntity.period,type:detalleNominaEntity.type} });
      ...
      return seqDetalleNominas.map((seqNomina) => {
        return new DetalleNomina(seqDetalleDetalleNomina.id,  seqDetalleDetalleNomina.enterprise, seqDetalleDetalleNomina.payrollId, seqDetalleDetalleNomina.employeeId, seqDetalleDetalleNomina.period, seqDetalleDetalleNomina.concept, seqDetalleDetalleNomina.conceptName, 
            seqDetalleDetalleNomina.valor,  seqDetalleDetalleNomina.percentaje,  seqDetalleDetalleNomina.conceptType, seqDetalleDetalleNomina.type, seqDetalleDetalleNomina.user);
