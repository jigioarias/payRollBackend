...
module.exports = class {
  ...
  async persist(personaEntry) {
    ...
    const seqPersona = await this.model.create({ firstName, lastName, phone, email,document,typeDocument , salary,nit,payRollType,salaryType,active,address,country,department,municipality,user,civilState});
