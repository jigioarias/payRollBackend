...
sequelize.import('./models/Licencias');
sequelize.import('./models/Incapacidades');
sequelize.import('./models/GrupoConceptos');
sequelize.import('./models/Prestamo');
sequelize.import('./models/PeriodoPrestamo');
sequelize.import('./models/HorasExtras');
sequelize.import('./models/Coleccion');
sequelize.import('./models/ImagenColeccion');
