...
module.exports = async(id, enterprise, clase, description, 
...
const claseNomina = new ClaseNomina(id, enterprise, clase, description, vacationDays,vacationPrima,primatype,provisionservicedays,provisionservicetype,payrolltype,
    ...
    if (mensajeValidacionClaseNomina == null){
        claseNominac = await claseNominaRepository.merge(claseNomina);
