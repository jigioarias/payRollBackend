...
const licenciaEntity = new Licencia(null, idEmpresa, documento, null, null,null, null,null,empleado.id,ano,null,empleado.classPayRoll,null,active);
...
if(!existeNovedad) {
    const incapacidadEntity = new Incapacidad(null, idEmpresa, documento, null, null,null,null,empleado.id,ano,null,empleado.classPayRoll,null,active,null);
  ...
  if((fechaInicialValidacion<=fechaInicialSolicitud && fechaInicialSolicitud<=fechaFinalValidacion)
   ...
   // console.log('existe una novedad incapacidades',existeNovedad); 
