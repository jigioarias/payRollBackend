...
module.exports = async (enterprise,clase,period,employeeId, { novedadNominaRepository}) => {
  ...
  try {
   ...
   console.log('repository novedad',novedadNominaRepository);
   const novedadNomina = new NovedadNomina(null,enterprise,clase,employeeId,null,null,period,null,null,null,null,null); 
