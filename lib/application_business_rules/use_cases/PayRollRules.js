...
module.exports = class {
    ...
    static  calcularValorIncapacidad(diasTipoNomina,diasIncacidad,salario,porcentajetipoPago){

      try {
      let valor = 0;
      if(diasTipoNomina>0){
            valor =  ((salario/diasTipoNomina)*diasSalario)*(porcentajetipoPago/100);
