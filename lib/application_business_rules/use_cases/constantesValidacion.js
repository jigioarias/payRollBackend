...
//Clase
CLASE_NOMINA = 'La clase de nomina es obligatoria';
DESCRIPCION_CLASE_NOMINA ='La descripción de la clase de nómina es requerida';
DIAS_VACACIONES = 'Los dias de vacaciones son requeridos y mayores a cero';
TIPO_NOMINA = 'El tipo de nomina es requerido';
HORAS_MES = 'Las horas mes nomina son obligatorias';
HORAS_DIA = 'Las horas dia nomina son obligatorias';
CALENDARIO_LABORAL = 'El calendario Laboral es obligatorio';
TIPO_PERIODO = 'El tipo de periodo es obligatorio';
//Horas extras
