...
module.exports = async (enterprise, clase, period, year,active,user,month,initDate,endDate, { periodoClaseRepository }) => {
  ...
  let periodoClaseDTO = null;
   try {
        ...
        const periodoClase = 
        new PeriodClase(null, enterprise, clase, period,year, active,user,month,initDate,endDate);
      ...
      if (mensajeValidacionPeriodoClase == null){
        periodoClasec = await periodoClaseRepository.persist(periodoClase);
